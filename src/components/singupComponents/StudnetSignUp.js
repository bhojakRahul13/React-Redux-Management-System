...
import { addSignUpStudents } from "../../store/Actions/SingUpDataActions";
...
const StudnetSignUp = () => {
  ...
  const onSubmit = async (e) => {
    ...
    const data = { name, email, password, id, type: "Student" };
    dispatch(addSignUpStudents(data));
    history.push("/");
  };
